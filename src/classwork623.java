...
public class classwork623 {
    Random rand = new Random(); //declare random number generator

    public static void main(String[] args) {
        Random rand = new Random(); //declare random number generator
        int size = rand.nextInt(5) + 5; //this creates the random number
        int[] array = new int[size]; // this creates the array
        for (int i = 0; i < array.length; i++) { // this creates array
    ...
    public static int [] swap(int[] array, int index1, int index2) {//this public static int[] swap, swaps  2 random indexes in the array
